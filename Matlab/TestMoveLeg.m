...
x_P = zeros(6, 3);
U(1,:) = [x_0(1) - d2 - 150; x_0(2) + d3 + 50; x_0(3)-80].';
U(2,:) = [x_0(1) + d2 + 150; x_0(2) + d3 + 50; x_0(3)-80].';
U(3,:) = [x_0(1) - d - 150; x_0(2); x_0(3) - 80].';
U(4,:) = [x_0(1) + d + 150; x_0(2); x_0(3) - 80].';
U(5,:) = [x_0(1) - d2 - 150; x_0(2) - d3 - 50; x_0(3) - 80].';
U(6,:) = [x_0(1) + d2 + 150; x_0(2) - d3 - 50; x_0(3) - 80].';
...
[ AAA, B, C] = straight_step([delta_x/2; delta_y/2;0], x_0, [delta_x/2; delta_y/2;0], U, [0;0;0], [0;0;0], 0, frames-1);

A = [];
for i = 1:steps
    if i == 1
        delta_x_eff = delta_x/2;
        delta_y_eff = delta_y/2;
        x_f = x_0 + [delta_x_eff;delta_y_eff;0];
    elseif i == steps
        delta_x_eff = delta_x/2;
        delta_y_eff = delta_y/2; 
        x_f = x_0;
        ...
        delta_y_eff = delta_y;
        delta_x_eff = delta_x;
        x_f = x_0 + [delta_x_eff/2;delta_y_eff/2;0];
    end
    ...
    if mod(i,2) == 1
       %Move legs 1, 4 and 5
        u_f1 = U(1,:).' + [delta_x_eff;delta_y_eff;0];
        u_f4 = U(4,:).' + [delta_x_eff;delta_y_eff;0];
        u_f5 = U(5,:).' + [delta_x_eff;delta_y_eff;0];
       ...
       %Move legs 2, 3 and 6
        u_f2 = U(2,:).' + [delta_x_eff;delta_y_eff;0];
        u_f3 = U(3,:).' + [delta_x_eff;delta_y_eff;0];
        u_f6 = U(6,:).' + [delta_x_eff;delta_y_eff;0];
