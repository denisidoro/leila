      ...
      if (this.currentBuffer.length === 0 && byt === 0) {
        ...
        if (this.currentBuffer[0] === START_SYSEX && SYSEX_RESPONSE[this.currentBuffer[1]] && this.currentBuffer[this.currentBuffer.length - 1] === END_SYSEX) {
          if (this.currentBuffer[1] == GENERIC_RESPONSE) {
            ...
            board.emit('sysexResponse', {code: this.currentBuffer[2], data: this.currentBuffer.slice(3, -1)});
          }
          else
...
Board.prototype.sysex = function(command, data, s, parse) {
  ...
  if (data != null) {
    if (s != null) {
      ...
      d = Board.longToByteArray(data); // split values greater than 255
  }
