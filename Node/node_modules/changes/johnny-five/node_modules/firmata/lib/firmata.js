...
Board.prototype.sysex = function(command, data) {
  ...
  if (data == null)
    ...
    data = Board.longToByteArray(data); // split values greater than 255

  data = data.map(function(i) { return i & 0x3ff; }); // 0x7f = 127, 0x3ff = 1023
  write = [START_SYSEX, command].concat(data, [END_SYSEX]);
  //console.log(['sysex', command, data, write, new Buffer(write)]);
  console.log(['sysex', command]);
